const UIController = (function(){
    ...
    displayProduct = (item) => {
        ...
        newHtml = newHtml.replace('%img%', item.image); 
        newHtml = newHtml.replace('%id%', item._id); 
        newHtml = newHtml.replace('%title%', item.item); 
        newHtml = newHtml.replace('%category1%', item.category); 
        // newHtml = newHtml.replace('%category2%', data.category[1]); 
        // newHtml = newHtml.replace('%category3%', data.category[2]); 
